...
import sticker from "./pictures/sticker.jpg";
      ...
      <Row>
        <Col xs={12} lg={6}>
          <Carousel style={{ maxWidth: 600 }}>
            <Carousel.Item>
              <img className="d-block w-100" src={stickers} alt="First slide" />
            </Carousel.Item>

            <Carousel.Item>
              <img className="d-block w-100" src={sticker} alt="Third slide" />
            </Carousel.Item>
          </Carousel>
        </Col>
        ...
        <Col xs={12} lg={6} className="text-xs-right text-right text-white">
          <h1 className="display-4 text-right text-white font-weight-bold font-italic mr-3">
            BURST STICKERS (25 count)
          </h1>
          <div className="mr-3">
            <p className="lead font-italic">
              You are bidding for 25 count Burst Stickers, courtesy of  
              <a href="http:\\stickers.getburst.net" target="_blank" rel="noopener noreferrer" style={{textDecoration: "none", color: "white"}}> stickers.getburst.net.</a> 
              The auction will start after it gets the first transaction and will last 7 days, or 168 hours. 
              Please bid with confidence, all profits will be donated to the Burst Marketing Fund.
              Free worldwide shipment.
              Before bidding, please see the FAQ.
            </p>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              >
                ...
                {!startTimer & !finished ? (
                  "Auction timer will start after the first bid"
                ) : startTimer & !finished ? (
